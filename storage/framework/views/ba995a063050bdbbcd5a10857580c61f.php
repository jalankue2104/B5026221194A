    ...
    <section class="sub-section-alternative" id="project">
          ...
          <div class="project-container">
              <div class="project-card">
                  <img class="project-image" src="asetugasets/imghello.png" alt="Project One Image"/>
                  <h3>Hello !</h3>
                  <p class="subtext">This is my project and some text about it. I enjoyed making this project.</p>
                  <hr/>
                  <p class="subtext"><a class="project-link" href="http://127.0.0.1:8000/hello">View here</a></p>
              </div>
              <div class="project-card">
                <img class="project-image" src="asetugasets/imglinktree.png" alt="Project One Image"/>
                <h3>Tugas Linktree</h3>
                <p class="subtext">This is my project and some text about it. I enjoyed making this project.</p>
                <hr/>
                <p class="subtext"><a class="project-link" href="http://127.0.0.1:8000/tugaslinktree">View here</a></p>
              </div>
              <div class="project-card">
                <img class="project-image" src="asetugasets/imgbootstrap1.png" alt="Project One Image"/>
                <h3>Latihan Bootstrap</h3>
                <p class="subtext">This is my project and some text about it. I enjoyed making this project.</p>
                <hr/>
                <p class="subtext"><a class="project-link" href="http://127.0.0.1:8000/bootstrap">View here</a></p>
              </div>
              <div class="project-card">
                <img class="project-image" src="asetugasets/imgbootstrap.png" alt="Project One Image"/>
                <h3>Tugas Bootstrap</h3>
                <p class="subtext">This is my project and some text about it. I enjoyed making this project.</p>
                <hr/>
      ...
      <section class="sub-section-alternative" id="">
          <div class="project-container">
          <div class="project-card">
                <img class="project-image" src="asetugasets/imgtugascss.png" alt="Project One Image"/>
                <h3>Tugas CSS</h3>
                <p class="subtext">This is my project and some text about it. I enjoyed making this project.</p>
                <hr/>
                <p class="subtext"><a class="project-link" href="http://127.0.0.1:8000/tugascss">View here</a></p>
              </div>
              <div class="project-card">
                  <img class="project-image" src="asetugasets/imgjs2.png" alt="Project One Image"/>
                  <h3>Tugas JS2</h3>
                  <p class="subtext">This is my project and some text about it. I enjoyed making this project.</p>
                  <hr/>
                  <p class="subtext"><a class="project-link" href="http://127.0.0.1:8000/js2">View here</a></p>
              </div>
              <div class="project-card">
                <img class="project-image" src="asetugasets/imgvalidasi.png" alt="Project One Image"/>
...
<?php /**PATH C:\Users\ARAYZI\OneDrive\Documents\Github\B5026221194A\resources\views/welcome.blade.php ENDPATH**/ ?>